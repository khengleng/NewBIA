...
class KeyPair {
  ...
  factory KeyPair.generateEc(Identifier curve) {
    ...
    final pair = generator.generateKeyPair();
    final pc.ECPublicKey publicKey = pair.publicKey as pc.ECPublicKey;
    final pc.ECPrivateKey privateKey = pair.privateKey as pc.ECPrivateKey;

    return KeyPair(
        publicKey: EcPublicKey(
            xCoordinate: publicKey.Q!.x!.toBigInteger()!,
            yCoordinate: publicKey.Q!.y!.toBigInteger()!,
            curve: curve),
        privateKey: EcPrivateKey(
            eccPrivateKey: privateKey.d!, curve: curve));
  }
