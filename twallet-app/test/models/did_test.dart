...
void main() {
  group('DID', () {
    test('Test valid DID parse', () {
      expect(
        DID.parse('did:tw:816F81681dC8dd12039c05B0093ccce24B4215f4'),
        isA<DID>(),
      );
    });
    ...
    test(
        ...
        () {
      expect(
        DID.parse('did:tw:816F81681dC8dd12039c05B0093ccce24B4215f4').toString(),
    ...
    test('Test invalid address parse, should throw ArgumentError', () {
      expect(
        () => DID.parse('did:tw:816F81681dC8dd12039c05B0093ccce24B4215'),
        throwsArgumentError,
      );
    });
    ...
    test('Test invalid format parse, should throw ArgumentError', () {
      expect(
        () => DID.parse('816F81681dC8dd12039c05B0093ccce24B4215f4'),
        throwsArgumentError,
      );
    });
  });
