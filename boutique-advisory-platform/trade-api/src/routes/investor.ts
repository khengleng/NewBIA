  ...
  try {
    ...
    const syndicateItems = syndicateInvestments.map((inv) => {
      ...
      return {
        ...
        tokenName: inv.syndicate?.tokenName || null,
        tokenSymbol: inv.syndicate?.tokenSymbol || null,
        tokenContractAddress: inv.syndicate?.tokenContractAddress || null,
        onchainStatus: inv.syndicate?.onchainStatus || null,
