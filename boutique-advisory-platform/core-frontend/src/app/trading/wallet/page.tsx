...
export default function WalletPage() {
    ...
    useEffect(() => {
        ...
        const handleUpdate = (data: any) => {
            // In a real app we might have a 'wallet_update' event
            // For now, if market_update happens, we re-fetch briefly 
            // but we can also add a specific listener if the backend emits it
            if (data.type === 'TRADE_EXECUTED' || data.type === 'DEPOSIT_CONFIRMED') {
                fetchWalletData()
            }
        }
    ...
    const handleDeposit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                addToast('success', 'Simulated deposit successful! Balance updated.')
        ...
        <DashboardLayout>
            <div className="space-y-6 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-400 mt-1">Manage your funds and track your trading history.</p>
                    </div>
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
                            ...
                            <p className="mt-2 text-[11px] text-gray-500">Funds available for spot trading.</p>
                        </div>

                        {/* Frozen Balance */}
                        <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
                            <div className="flex items-center justify-between mb-4">
                                <p className="text-gray-400 text-sm">In Orders / Frozen</p>
                            ...
                            <p className="mt-2 text-[11px] text-gray-500">Locked in open orders or pending settlement.</p>
                        </div>
                    </div>
                )}
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-2xl overflow-hidden shadow-xl">
                    <div className="p-6 border-b border-gray-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="bg-gray-900 text-gray-500 px-2 py-0.5 rounded text-xs border border-gray-700">
                                Last 50 items
                            </span>
                        </div>
                            ...
                            <tbody className="divide-y divide-gray-700/50">
                                {isLoading ? (
                                    ...
                                    filteredTransactions.map(tx => {
                                        ...
                                        const isTrade = tx.type.startsWith('TRADE_')
                                        return (
                                            <tr key={tx.id} className="hover:bg-gray-700/30 transition-colors group">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex flex-col">
                                                        ...
                                                        {tx.metadata?.tradeId && (
                                                            <span className="text-[10px] text-gray-500">ID: {tx.metadata.tradeId}</span>
                                                        )}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
            ...
            {isDepositModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-gray-800 border border-gray-700 w-full max-w-md rounded-2xl shadow-2xl relative overflow-hidden transition-all scale-up animate-in slide-in-from-bottom-4 duration-200">
                        <div className="p-6 border-b border-gray-700">
                            <h3 className="text-xl font-bold text-white">Deposit USDT</h3>
                            <p className="text-gray-400 text-sm mt-1">Add funds to your trading wallet via ABA PayWay.</p>
                        </div>
                        <div className="p-6 space-y-4">
                            ...
                            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex gap-3">
                                ...
                                <div className="text-xs text-blue-300 leading-relaxed">
                                    Note: Settlement time for real ABA transfers is near-instant, but some banks may experience processing delays.
                                </div>
                            </div>
                        </div>
